...
GameWindow::game_init()
{
    ...
    background1 = al_load_bitmap("./Asset/school.jpg");
    background2 = al_load_bitmap("./Asset/home.jpg");
    background3 = al_load_bitmap("./Asset/starry.png");
    background_menu = al_load_bitmap("./Asset/menu.png");
    background_charchoose = al_load_bitmap("./Asset/characterchoose.png");
    background_charstory = al_load_bitmap("./Asset/characterstory.png");
    background_introduce = al_load_bitmap("./Asset/introduce.png");
    background_pause = al_load_bitmap("./Asset/pause.png");
    background_win = al_load_bitmap("./Asset/win.png");
    background_lose = al_load_bitmap("./Asset/lose.png");
    background_P1_P2 = al_load_bitmap("./Asset/P1_P2.png");
    background_P2_P1 = al_load_bitmap("./Asset/P2_P1.png");
    background_P2_P1bocchi = al_load_bitmap("./Asset/P2_P1bocchi.png");
    background_P2_P1ijichi = al_load_bitmap("./Asset/P2_P1ijichi.png");
    background_P2_P1kita = al_load_bitmap("./Asset/P2_P1kita.png");
    background_P2_P1yamada = al_load_bitmap("./Asset/P2_P1yamada.png");
    background_mapchoose = al_load_bitmap("./Asset/mapchoose.png");
    speedtool = al_load_bitmap("./Asset/speedtool.png");
...
GameWindow::game_update() 
{
    //test if is legal
    //player1
    int target1, target2, target3, target4, speed;

    speed = bandmemberSet[player1]->get_speed();

    int dir = bandmemberSet[player1]->getDir();
    int x_now = bandmemberSet[player1]->getX();
    int y_now = bandmemberSet[player1]->getY();
    int x_next = (x_now+axis_x[dir]*speed);
    int y_next = (y_now+axis_y[dir]*speed);
    ...
    //player3
    speed = bandmemberSet[player3]->get_speed();
    ...
    //player4
    speed = bandmemberSet[player4]->get_speed();
...
GameWindow::draw_running_map(int scene)
{
    ...
    switch (scene) {
        case GAMESCHOOL:
            ...
            break;
        case GAMEHOME:
            wall = al_load_bitmap("./Asset/homewall.png");
            stone = al_load_bitmap("./Asset/homestone.png");
            al_draw_bitmap(background2, 0, 0, 0);
            break;
        case GAMESTARRY:
            wall = al_load_bitmap("./Asset/starrywall.png");
            stone = al_load_bitmap("./Asset/starrystone.png");
    ...
    for(i = 0; i < field_height/40; i++)
    {
        for(j = 0; j < field_width/40; j++)
        {
            ...
            if(level->isStone(tmp)) {
                ...
                al_draw_bitmap(stone, j*40-20, i*40-20, 0);
            }
                ...
                al_draw_bitmap(wall, j*40-20, i*40-20, 0);
            }
